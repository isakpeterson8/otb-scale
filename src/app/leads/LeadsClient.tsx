...
import { LEAD_SOURCES, LEAD_SUB_SOURCES } from '@/types/database'
    ...
    <div className="space-y-5">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-[var(--accent)] text-[var(--ink)] text-sm font-medium hover:bg-[var(--accent-text)] hover:text-[var(--canvas)] transition-colors self-start sm:self-auto"
        >
          <svg
            width="14"
            height="14"
                  ...
                  <div key={contact.id} className="flex items-center gap-3 px-4 py-3.5">
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      <button
                        ...
                        className="p-2 rounded-lg text-[var(--ink-3)] hover:text-[var(--ink)] transition-colors"
                        title="Edit"
                      >
                        <svg
                          width="14"
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg text-[var(--ink-3)] hover:text-[var(--red)] transition-colors disabled:opacity-50"
                        title="Delete"
                      >
                        <svg
                          width="14"
                        ...
                        >
                          <path
                            d="M2 4h10M5 4V2h4v2M5.5 6.5v4M8.5 6.5v4M3 4l.7 7.3A1 1 0 004.7 12h4.6a1 1 0 001-.7L11 4"
                            stroke="currentColor"
                            strokeWidth="1.3"
                            strokeLinecap="round"
                          />
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-[var(--ink)]/8">
                    <th className="text-left px-5 py-3 text-xs text-[var(--ink-3)] font-medium uppercase tracking-wide">
                      Name
                    </th>
                    <th className="text-left px-5 py-3 text-xs text-[var(--ink-3)] font-medium uppercase tracking-wide">
                      Email
                    ...
                    <th className="text-left px-5 py-3 text-xs text-[var(--ink-3)] font-medium uppercase tracking-wide hidden lg:table-cell">
                      Source
                    </th>
                    <th className="text-left px-5 py-3 text-xs text-[var(--ink-3)] font-medium uppercase tracking-wide hidden lg:table-cell">
                      Added
                      ...
                      >
                        <td className="px-5 py-3">
                          <div className="flex items-center gap-2.5">
                            ...
                            <span className="font-medium text-[var(--ink)] truncate max-w-[140px]">
                              {contact.name}
                            </span>
                          </div>
                        </td>
                        ...
                        <td className="px-5 py-3 text-[var(--ink-3)] text-xs hidden lg:table-cell max-w-[180px]">
                          {sourceLabel ? (
                            <span className="truncate block" title={sourceLabel}>
                              {sourceLabel}
                            </span>
                          ) : (
                            '—'
